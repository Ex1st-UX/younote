...
var Component = /*#__PURE__*/function () {
  function Component() {
    ...
    this.popupNode = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.popup');
    this.popupContentNode = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.popup-content');
    this.taskListContentNode = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.task_content');
  ...
  _createClass(Component, [{
    ...
    value: function events() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.list-group-item').on('click', this.openEditor.bind(this));
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.task_add__button').on('click', this.addTaskSlide.bind(this));
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.task_filter__button').on('click', this.filterOpen.bind(this));
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#popup_close__button', this.closeEditor.bind(this));
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.add_custom_tag__button', this.addCustomTag.bind(this));
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('submit', this.createTaskFormId, this.addTaskSubmit.bind(this));
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('submit', '#filter__form', this.onFilterSubmit.bind(this));
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.list-group-item', this.selectTask.bind(this));
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', '#sort__select', this.onSortChange.bind(this));
    }
  }, {
    key: "loadTaskList",
    value: function loadTaskList() {
      var _this2 = this;
      var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var orderBy = this.orderBy ? this.orderBy : 'created_at';
      this.sendRequest('/tasks/get/list/sort/' + orderBy, this.flterFormdata, _objectSpread({
        contentType: 'application/json'
      }, params), function (response) {
        _this2.getTemplate('list_tasks', JSON.stringify(response)).then(function (node) {
          _this2.render(node, _this2.taskListContentNode);
        });
      });
    }
  }, {
    key: "onFilterSubmit",
    value: function onFilterSubmit(event) {
      event.preventDefault();
    ...
    value: function onSortChange() {
      this.orderBy = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).val();
      this.loadTaskList({
        processData: false,
        contentType: false
      });
    ...
    key: "filterOpen",
    value: function filterOpen() {
      var _this3 = this;
      this.getTemplate('filter', this.flterFormdata, false).then(function (node) {
        _this3.render(node, _this3.popupContentNode);
        _this3.openEditor();
      });
    }
  }, {
    key: "selectTask",
    value: function selectTask() {
      var _this4 = this;
      var taskId = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).data('id');
      if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).hasClass('list-group-item')) {
        return;
      }
      this.openEditor();
      this.sendRequest('/tasks/get/id/' + taskId, {}, {
        contentType: 'application/json'
      }, function (response) {
        _this4.getTemplate('task', JSON.stringify(response)).then(function (node) {
          _this4.render(node, _this4.popupContentNode);
        });
      });
    }
  }, {
    key: "addTaskSubmit",
    value: function addTaskSubmit(e) {
      var _this5 = this;
      e.preventDefault();
      var form = document.querySelector(this.createTaskFormId);
      var formData = new FormData(form);
      var _this = this;
      this.sendRequest('/tasks/create', formData, {
        processData: false,
        contentType: false,
        ...
        _this5.getTemplate('task', JSON.stringify(response)).then(function (node) {
          _this5.render(node, _this5.popupContentNode);
          _this5.openEditor();
        });
      });
    }
    ...
    key: "addTaskSlide",
    value: function addTaskSlide() {
      var _this6 = this;
      this.getTemplate('create_task').then(function (node) {
        _this6.render(node, _this6.popupContentNode);
        _this6.openEditor();
      });
    }
  }, {
    key: "addCustomTag",
    value: function addCustomTag() {
      var $inputWrapperNode = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tag_name_input__wrapper');
      var html = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="col-sm-10 tag_name_input__content">' + '   <input type="text" class="form-control" name="tag_task__input[]" placeholder="Tag name ...">' + '</div>');
      $inputWrapperNode.append(html);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tag_name_input__content').fadeIn(400);
    }
  }, {
    key: "openEditor",
    ...
    key: "getTemplate",
    value: function () {
      var _getTemplate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(templateName) {
        var data,
          contentType,
          node,
          _args = arguments;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return this.sendRequest('templates/render/' + templateName, data, {
            ...
            case 4:
              return _context.abrupt("return", jquery__WEBPACK_IMPORTED_MODULE_0___default()(node));
            case 5:
            case "end":
    ...
    value: function sendRequest(url, data) {
      ...
      return jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax(_objectSpread(_objectSpread({}, mergedParams), {}, {
        headers: {
    ...
    key: "render",
    value: function render(node, targetNode) {
      targetNode.empty();
